...
# override the installed Pytorch

# step 1: uninstall torch
RUN ${ISAACLAB_PATH}/_isaac_sim/python.sh -m pip uninstall -y torch torchvision torchaudio

# step 2: install the latest pytorh ------ For Linux and Windows ONLY
RUN ${ISAACLAB_PATH}/_isaac_sim/python.sh -m pip install --pre torch torchvision torchaudio --index-url --index-url https://download.pytorch.org/whl/cu128
